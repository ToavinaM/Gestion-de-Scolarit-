            ...
            <div class="row h-100">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="header">
                                <img src="../page/assets/img/dim.png" width="80%" height="80%" alt="diademe">
                            </div>
                        </div>
                        <div class="col-md-9 ">
                            <input type="text" class="search" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                    ...
                    <div class="row">
                        <div class="col-md-12 main">
                            <h1 style="text-align: center;">Inscription Eleve</h1>
                            <!-- <div class="row">
